...
export default {
    ...
    methods: {
        ...
        //     formData.append('id_perso', this.id_perso);
        //     formData.append('id_acte', this.id_acte);
        //     formData.append('id_fsactuel', this.id_fsactuel);
        //     formData.append('id_fsnouvelle', this.id_fsnouvelle);
        //     try {
        //         const response = await axios.post('http://localhost:3000/lieu_service', formData, {
        //             headers: {
