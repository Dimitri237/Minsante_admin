...
<div class="btn" style="border: none; width: 100%; height: 150px; background-color: #007A5E; color: white;">
        <button style="border: none; padding: 10px 10px; background-color: #007A5E; color: white;" type="button"
          ...
          Ajouter un type d'acte <i style="color: white;" class="fa fa-plus"></i>
        </button>
  </div>
  </div>
  ...
  <div v-if="modalVisible2" class="modals2">
    <div class="details2 animate__animated animate__fadeInDown">
      ...
      <div style="width: 100%; padding: 10px;">
        <h2 style="margin: 0; color: #007A5E; padding: 0;">Créer un type d'acte</h2>
      </div>
      <form @submit.prevent="createTypeactes">
        <div class="inp-field">
        ...
        <div style="width: 95%; display: flex; justify-content: space-between;">
          <button class="sub_butt" type="submit">Créer le type d'acte</button>
...
export default {
  ...
  methods: {
    ...
    async createTypeactes() {
      try {
        const response = await axios.post('https://minsante-api-636b67309a26.herokuapp.com/type_actes', {
