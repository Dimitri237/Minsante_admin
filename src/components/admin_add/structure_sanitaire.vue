...
export default {
  ...
  methods: {
    ...
    async createStructure() {
      try {
        const response = await axios.post('http://192.168.100.116:3000/formation_sanitaire', {
    ...
    async getTypefs() {
      try {
        const response = await axios.get('http://192.168.100.116:3000/type_fs'); // Appeler l'API GET
    ...
    async getRegion() {
      try {
        const response = await axios.get('http://192.168.100.116:3000/region'); // Appeler l'API GET
