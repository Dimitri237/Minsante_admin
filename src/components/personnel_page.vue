<template>
    <div class="personnel_list">
        ...
        <router-link class="objets" v-for="personnel in personnels" :key="personnel.matricule" :to="'/PersonnelDetails/' +  personnel.matricule">
            <label for="" class="attr">{{ personnel.nom_prenom }}</label>
            <label for="" class="attr">{{ personnel.matricule }}</label>
            <label for="" class="attr">{{ personnel.profession }}</label>
            <label for="" class="attr">{{ personnel.lieu_service }}</label>
    ...
    <div v-if="modalVisible2" class="modals">
        <div class="details animate__animated animate__fadeInDown">
            ...
            <div class="text detail_perso">
                ...
                <div class="lieu-service-section">
                    <h2 style="color: #007A5E;">Formations</h2>
                    <div class="lieu-service-item" v-for="selectedFormation in selectedFormations"
                        :key="selectedFormation.id">

                        <div class="list_detail">
                            <label>Admis en stage le: </label>
                            <h3>{{ selectedFormation.create_at }}</h3>
                        </div>
                        <div class="list_detail">
                            <label>A:</label>
                            <h3>{{ selectedFormation.id_fs }}</h3>
                        </div>
                        <div class="list_detail">
                            <label>Telephone: </label>
                            <h3>{{ selectedFormation.telephone }}</h3>
                        </div>
                    </div>
                </div>
            </div>
