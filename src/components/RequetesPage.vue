...
export default {
    ...
    methods: {
        ...
        async showModal2(mise) {
            ...
            try {
                await axios.get(`https://minsante-api-636b67309a26.herokuapp.com/mise_stage/` + mise.id_perso).then(
                    res => {
        ...
        async showModal3(service) {
            ...
            try {
                await axios.get(`https://minsante-api-636b67309a26.herokuapp.com/priseService_repriseService/` + service.id_perso).then(
                    res => {
        ...
        async getMiseStage() {
            try {
                const response = await axios.get('https://minsante-api-636b67309a26.herokuapp.com/mise_stage'); // Appeler l'API GET
        ...
        async getPriseservice() {
            try {
                const response = await axios.get('https://minsante-api-636b67309a26.herokuapp.com/priseService_repriseService'); // Appeler l'API GET
        ...
        ApprouverPrise() {
            ...
            fetch('https://minsante-api-636b67309a26.herokuapp.com/update-status/' + this.selectedService.id_perso, {
                method: 'POST',
                headers: {
